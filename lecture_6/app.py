...
"""Definition of the Database and ORM Model."""
class BookDB(Base):
    __tablename__ = "books"
...
app = FastAPI(
    ...
    description="A simple API to manage book collection with Docker",
    version="1.0.0"
)
...
"""Healthcheck endpoint (REQUIRED FOR DOCKER LAB)"""
@app.get("/healthcheck")
...
def root():
    ...
    return {
        ...
        "endpoints": {
            ...
            "GET /healthcheck": "Health check (returns {'status': 'ok'})"
        }
    }
